...
{
    integer_Map_Init(&GameState->KeyMappings,HashInt,sizeof(int*), 512);
...
{
    integer_Map_Init(&GameState->MouseButtonMappings,HashInt,sizeof(int*),16);
...
{
    integer_Map_Init(&GameState->ControllerMappings,HashInt,sizeof(int*),32);
