...
CommonCompilerFlags="-isystem ../libs -isystem ../libs/glfw/include -I ../libs/openal/include -isystem ../libs/FreeType/include -isystem ../libs/glad/include -isystem ../libs/fmod/include -g"
