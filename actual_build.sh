...
CommonCompilerFlags="-pthread -isystem ../libs -isystem $VULKAN_SDK/include -isystem ../libs/glfw/include  -isystem ../libs/glad/include -isystem ../libs/fmod/include -isystem ../libs/gameanalytics/source/gameanalytics"
CommonLinkerFlags=" -L../libs/glad -L/usr/local/lib -L../libs/glfw/libglfw3.a -L../libs/glfw -L../libs/fmod/lib ../libs/gameanalytics/source/dependencies/curl/lib/linux_x64/libcurl.a ../libs/gameanalytics/source/dependencies/openssl/1.0.2h/libs/linux_x64/* ../libs/gameanalytics/linux_x64-clang-static/Release/libGameAnalytics.a  -ldl -lm -lpng -lz -lfmod -lglad -lglfw -o $EXECUTABLE_NAME -Wl,-rpath,\$ORIGIN/../build"
