...
echo %cd%
set CommonCompilerFlags=/MD -fp:fast -fp:except- -nologo -Od -Oi -Wall -Gm- -GR- -EHa -FC -Z7 %PRP% %WIGNORED% %DEBUG% %GLM% /I..\libs /I..\libs\glfw\include  /I..\libs\glad\include /I ..\libs\fmod\include /I..\libs\vulkan\Include
