...
CommonCompilerFlags="-pthread -isystem /usr/include/c++/7 -isystem ../libs  -isystem ../libs/glfw/include  -isystem ../libs/glad/include -isystem ../libs/fmod/include -isystem ../libs/gameanalytics/source/gameanalytics"
