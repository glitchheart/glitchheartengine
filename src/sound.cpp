...
static inline void PlaySoundEffect(sound_commands* SoundCommands, i32 BufferHandle, b32 Loop = false, i32 LoopCount = -1, r32 Pitch = 1.0f, r32 RollOff = 0.0f, r32 X = 0.0f, r32 Y = 0.0f)
{
