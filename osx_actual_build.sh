...
CommonCompilerFlags="-isystem ../libs -isystem ../libs/glfw/include -isystem ../libs/glad/include -isystem ../libs/fmod/include"
CommonLinkerFlags="../libs/glad/osx/glad.o -L/usr/local/lib -L../libs/glfw/osx/ -L../libs/fmod/lib/osx/ -ldl -lc++ -lm -lz -lfmod -lglfw3 -framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo -o main -rpath @executable_path"

pushd build

clang --std=c++17 -Weverything $WIGNORE $DEBUG $CommonCompilerFlags -g -O0 ../src/main.cpp $CommonLinkerFlags
