...
echo %cd%
set CommonCompilerFlags=/MD -nologo -Od -Oi -Wall -Gm- -EHsc -FC -Z7 %PRP% %WIGNORED% %DEBUG% %GLM% /I..\libs /I..\libs\glfw\include  /I..\libs\glad\include /I ..\libs\fmod\include /I%VULKAN_SDK%\include
set CommonLinkerFlags= Comdlg32.lib Ole32.lib kernel32.lib user32.lib gdi32.lib winmm.lib opengl32.lib shell32.lib ..\libs\glfw\lib-vc2015\glfw3.lib ..\libs\glad\glad.obj  %VULKAN_SDK%\Lib\vulkan-1.lib ..\libs\fmod\lib\fmod64_vc.lib
