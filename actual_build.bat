...
set GLM=
set PRP=
set WIGNORED=-wd5039 -wd4201 -wd4505 -wd4100 -wd4996 -wd4456 -wd4127 -wd4582 -wd4587 -wd4820 -wd4061 -wd4710 -wd4191 -wd4623 -wd4625 -wd5026 -wd4668 -wd4312 -wd5045 -wd4577 -wd4711
set OPT=-Od
...
echo %cd%
set CommonCompilerFlags=/MD /arch:AVX -fp:fast -fp:except- -nologo %OPT% -Oi -Wall -Gm- -GR- -EHa -FC -Z7 %PRP% %WIGNORED% %DEBUG% %GLM% /I..\libs /I..\libs\glfw\include  /I..\libs\glad\include /I ..\libs\fmod\include /I..\libs\vulkan\Include
