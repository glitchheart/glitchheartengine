...
CommonCompilerFlags="-isystem ../libs -isystem ../libs/glfw/include -isystem ../libs/glad/include -I../libs/glad/src/glad.c -isystem ../libs/fmod/include -g"
CommonLinkerFlags=" -L../libs/glad/osx/ -L/usr/local/lib -L../libs/glfw/osx/ -L../libs/fmod/lib/osx/ -ldl -lm -lpng -lz -lfmod -lglfw3 -lglad -framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo ../libs/glad/osx/glad.o -rpath @executable_path -o main"
