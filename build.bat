...
echo %cd%
set CommonCompilerFlags=/MDd -std:c++latest -fp:fast -fp:except- -nologo %OPT% -Oi -W4 -Gm- -GR- -EHa -FC -Z7 -Fe%EXECUTABLE_NAME% %PRP% %WIGNORED% -DDEBUG=%DEBUG% %GLM% /I..\libs /I..\libs\glfw\include /I..\libs\glad\include /I ..\libs\fmod\include /I..\libs\vulkan\Include
set CommonLinkerFlags= Comdlg32.lib Ole32.lib Shlwapi.lib kernel32.lib user32.lib gdi32.lib winmm.lib opengl32.lib shell32.lib ..\libs\glfw\lib-vc2015\glfw3.lib ..\libs\glad\glad.obj ..\libs\fmod\lib\fmod64_vc.lib
