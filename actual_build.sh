...
CommonLinkerFlags=" -L../libs/glad -L/usr/local/lib -L../libs/glfw/libglfw3.a -L../libs/glfw -L../libs/fmod/lib  -ldl -lm -lpng -lz -lfmod -lglad -lglfw -o main -Wl,-rpath,\$ORIGIN/../build  ../libs/gameanalytics/source/dependencies/curl/lib/linux_x64/libcurl.a ../libs/gameanalytics/source/dependencies/openssl/1.0.2h/libs/linux_x64/* ../libs/gameanalytics/linux_x64-clang-static/Release/libGameAnalytics.a"
