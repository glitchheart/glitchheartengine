...
echo %cd%
set CommonCompilerFlags=/MD /arch:AVX -std:c++latest -fp:fast -fp:except- -nologo %OPT% -Oi -W4 -Gm- -GR- -EHa -FC -Z7 %PRP% %WIGNORED% %DEBUG%  %GLM% /I..\libs /I%AnalyticsSrcPath%\gameanalytics\ /I..\libs\glfw\include /I..\libs\libcurl\include  /I..\libs\glad\include /I ..\libs\fmod\include /I..\libs\vulkan\Include
...
if defined DEBUG set ExtraLinkerFlags = %ExtraLinkerFlags% /subsystem:windows /entry:mainCRTStartup
