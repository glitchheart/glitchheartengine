...
set CommonCompilerFlags=/MD -nologo -Od -Oi -W4 -Gm- -EHsc -wd4201 -wd4100 -wd4189 -wd4530 -wd4577 -wd4996 -wd4456 -FC -Z7 %DEBUG% /I..\libs /I..\libs\glfw\include /I..\libs\openal\include /I..\libs\freetype\include /I..\libs\glad\include 
