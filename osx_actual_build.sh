...
CommonLinkerFlags=" -L../libs/glad/osx/ -L/usr/local/lib -L../libs/glfw/osx/ -L../libs/fmod/lib/osx/ -ldl -lfreetype -lm -lpng -lz -lfmod -lglfw3 -lglad -framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo -F$VULKAN_SDK/Frameworks -framework Vulkan ../libs/glad/osx/glad.o -rpath @executable_path -o main"
