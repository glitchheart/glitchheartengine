                              ...
                              {
                                  r32* VertexBuffer = PushTempArray(16 * Tilemap.Width * Tilemap.Height, r32);
                              ...
                              static void SaveLevelToFile(const char* FilePath, level* Level, game_state* GameState, renderer& Renderer, b32 New = false)
                              {
                                  FILE* File;
                                  File = fopen(FilePath, "w");
